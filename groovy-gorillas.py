      ...
      BWBWBBBBXBWBWBBBB
       BWBWBBXXXBWBWBB
        BBBXXXXBXBBBB
         BpBXXXBpB
      BBBBppBBBppBBBBB
   BBBGGGBpBsBsBpBggggBBB
  BGGGGGGGBBsBssBGgggggggB
 BGGGGGGGGgBsBWsBGggggggggB
 BGGgBGGGGgBsBssBGggggBGggB
BGGgB BGGGgBsBssBGgggB BGggB
BGGgB BBGGgBsBWsBGggBB BGggB
BGGgB   BGgBsBssBGgB   BGggB
 BGGgB  BGgBsBssBGgB  BGggB
 BGGBB  BGgBsBWsBGgB  BBggB
  BBXXX BGgBsBssBGgB XXXBB
   XXXXXBGgBBBBBBGgBXXXXX
       BGGgBGGGGBGgB
     BBBGGgBBBBBBGggBB
     BGBBBBB    BBBBBB
    BGGgB         BGggB
...
GOR_LEFT_ASCII = """
  ...
  BBXXX   XXXXXXXX
 BGgBB    XXXXXXXX
 BGGBBBBBBBBBBBBBBBBBBBBBB
BGGgBBWBWBBBBBBWBWBBBBBB
BGGgB BWBWBBBBXBWBWBBBB
BGGgB  BWBWBBXXXBWBWBB
 BGGgB  BBBXXXXBXBBBB
 BGGgB   BpBXXXBpB
  BGGgBBBBppBBBppBBBBB
   BBBGGGBpBsBsBpBggggBBB
      BGGGgBsBssBGgggggggB
      BGGGgBsBWsBGggggggggB
      BGGGgBsBssBGggggBGggB
      BGGGgBsBssBGgggB BGggB
      BBGGgBsBWsBGggBB BGggB
        BGgBsBssBGgB   BGggB
        BGgBsBssBGgB  BGggB
        BGgBsBWsBGgB  BBggB
        BGgBsBssBGgB XXXBB
...
GOR_RIGHT_ASCII = """
          ...
          XXXXXXXX   XXXBB  
          XXXXXXXX    BBgGB 
  BBBBBBBBBBBBBBBBBBBBBBGGB 
    BBBBBBWBWBBBBBBWBWBBgGGB
     BBBBWBWBXBBBBWBWB BgGGB
      BBWBWBXXXBBWBWB  BgGGB
       BBBBXBXXXXBBB  BgGGB 
          BpBXXXBpB   BgGGB 
      BBBBBppBBBppBBBBgGGB  
   BBBggggBpBsBsBpBGGGBBB   
  BgggggggGBssBsBgGGGB      
 BggggggggGBsWBsBgGGGB      
 BggGBggggGBssBsBgGGGB      
BggGB BgggGBssBsBgGGGB      
BggGB BBggGBsWBsBgGGBB      
BggGB   BgGBssBsBgGB        
 BggGB  BgGBssBsBgGB        
 BggBB  BgGBsWBsBgGB        
  BBXXX BgGBssBsBgGB        
...
def makeSurfaceFromASCII(ascii, fgColor=(255,255,255), bgColor=(0,0,0), colourDict=None):
    ...
    for y in range(height):
        for x in range(len(ascii[y])):
            if colourDict and ascii[y][x] in colourDict:
                pArr[x][y] = colourDict[ascii[y][x]]
            elif ascii[y][x] == 'X':
                pArr[x][y] = fgColor
    return surf

GOR_DOWN_SURF    = makeSurfaceFromASCII(GOR_DOWN_ASCII,    GOR_COLOR,      SKY_COLOR, GOR_COLOURS)
GOR_LEFT_SURF    = makeSurfaceFromASCII(GOR_LEFT_ASCII,    GOR_COLOR,      SKY_COLOR, GOR_COLOURS)
GOR_RIGHT_SURF   = makeSurfaceFromASCII(GOR_RIGHT_ASCII,   GOR_COLOR,      SKY_COLOR, GOR_COLOURS)
